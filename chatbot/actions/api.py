...
class ApiAddress():
    ...
    def api_request_object_2(self, alcaldia, colonia, calle):
    ...
    def bola_cerrada(self, direccion, radio=5):
        ...
        colonia = direccion[1]
        calle = direccion[2]
        latitud, longitud, dia, mes = self.api_request_object_2(alcaldia, colonia, calle)
...
if __name__=="__main__":
    ...
    api.bola_cerrada("ALVARO OBREGON, TLACOPAC, JARDIN 60")
